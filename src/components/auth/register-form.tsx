...
import { Github, Code2, Gift } from "lucide-react";
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background px-4 py-12">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-1/4 -right-1/4 h-[600px] w-[600px] rounded-full bg-secondary/10 blur-[120px]" />
      </div>
          ...
          <CardContent>
              ...
              <div className="space-y-1.5">
                ...
                {referralCode ? (
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Badge className="shrink-0 bg-gold/20 text-gold border-gold/30 whitespace-nowrap">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-surface/50 px-2 text-muted">
                  or continue with
                </span>
              </div>
            </div>
